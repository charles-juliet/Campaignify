    ...
    <div className="w-full md:flex items-start justify-around py-8">
      ...
      <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
        ...
        <div className="border-b pb-8 border-black">
          <h5 className="font-clashDisplay uppercase text-cyber-ink text-3xl">
            ${active === "Monthly" ? "9.99" : "7.08."} /month
          </h5>
        ...
        <Button
          ...
          onClick={() =>
            handleSubscription({
              price:
                active === "Monthly"
                  ? "price_1Pwh3ZB6JVYallBMmbwuHNPd"
                  : "price_1PwhbeB6JVYallBMHpA3BxZQ",
            })
          }
        >
          Get Started
        ...
        <p className="pt-1 opacity-[.7] text-center">
          30-day free trial of Grow features, then $
          {active === "Monthly" ? "9.99" : "7.08"}/mo
        </p>
      </div>
      ...
      <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
        ...
        <div className="border-b pb-8 border-[#000]">
          <h5 className="font-clashDisplay uppercase text-cyber-ink text-3xl">
            ${active === "Monthly" ? "19.99" : "15.42"} /month
          </h5>
          <p className="text-lg">Billed {active}</p>
        </div>
        <div className="pt-5">
        ...
        <Button
          ...
          onClick={() =>
            handleSubscription({
              price:
                active === "Monthly"
                  ? "price_1PwgvNB6JVYallBM2djhq2BX"
                  : "price_1PwheYB6JVYallBMHwZaV9CR",
            })
          }
        >
          Get Started
